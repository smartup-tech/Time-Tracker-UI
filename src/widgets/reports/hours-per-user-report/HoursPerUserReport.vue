...
import { getUserHoursPerDayColumns, useUserHoursReportConfig } from './config';
...
const { columns } = useUserHoursReportConfig();
    ...
    >
      <template #expandedRowRender="{ record }">
        ...
        <Table
          ...
          :columns="getUserHoursPerDayColumns(record.workHoursMap)"
          bordered
          :data-source="[record.workHoursMap]"
      ...
      <template #summary>
        <TableSummary fixed>
          <TableSummaryRow>
            ...
            <TableSummaryCell :row-span="2" :col-span="3"></TableSummaryCell>
...
:deep(.internal-table .ant-table-cell-row-hover) {
  &.weekend-cell {
    background: $bg-weekend-cell !important;
  }
  background: transparent !important;
}

:deep(.internal-table .ant-table-row) {
  &:hover > td {
    &.weekend-cell {
      background-color: $bg-weekend-cell !important;
    }
    background-color: transparent !important;
  }
}

:deep(.ant-table-cell.weekend-cell) {
  background-color: $bg-weekend-cell;
}
